...
* **Underlying Algorithm (DP):** The core calculation (finding the cheapest combination of smaller plates to build a larger one) is a variation of the 2D Cutting Stock problem, solved using Dynamic Programming.
